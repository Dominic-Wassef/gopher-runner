...
import (
	...
	"github.com/dominic-wassef/gopher-runner/internal/handlers"
...
func setupApp() (*string, error) {
	...
	identifier := flag.String("identifier", "gopher", "unique identifier")
	...
	databaseName := flag.String("db", "gopher", "database name")
	...
	preferenceMap["version"] = gopherVersion
